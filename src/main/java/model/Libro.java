...
public class Libro implements Serializable{
	...
	public Libro(String isbn, String titulo, String descripcion, String nombre_autor, String fecha_registro,
			int codigo_categoria, String publicacion, String nit_editorial) {
		this.isbn = isbn;
		this.titulo = titulo;
