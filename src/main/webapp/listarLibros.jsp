				...
				<div class="page-content">
					...
					<div class="row">
						<div class="col-xs-12">
							...
							<div class="row">
								<div class="col-xs-12">
									<div class="table-header">Resultados de libros
										registrados</div>
									...
									<div>
										<table id="dynamic-table"
											...
											<tbody>
												...
												%>
												<tr>
													<td><a href="#"><%=lib.getIsbn()%></a></td>
													<td class="hidden-480"><%= lib.getTitulo() %></td>
													<td><%= lib.getNombre_autor() %></td>

													<td><%= lib.getPublicacion() %></td>
													<td><span class="label label-sm label-success"><%= EditorialDao.getEditorial(lib.getNit_editorial()) %></span></td>
													<td><span class="label label-sm label-success"><%= CategoriaDao.getCategoria(lib.getCodigo_categoria()) %></span>
													</td>
