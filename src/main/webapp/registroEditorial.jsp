				...
				<div class="page-content">
					...
					<div class="row">
						<div class="col-xs-12">
							...
							<div class="row">
								<div class="col-xs-12">
									<div class="table-header">Registro de Editoriales</div>

									<!-- div.table-responsive -->

									<!-- div.dataTables_borderWrap -->
									<div>
										<form action="EditorialControl" method="post"
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													<input type="text" name="nit" value=""
														placeholder="Nit de la Editorial" />
												</div>
											</div>
											<div class="form-group">
												<label class="col-sm-3 control-label no-padding-right">
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													<input type="text" name="telefono" value=""
														placeholder="Telefono de la Editorial" />
												</div>
											</div>
											<div class="form-group">
												<label class="col-sm-3 control-label no-padding-right">
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													<input type="text" name="direccion" value=""
														placeholder="Direccion de la Editorial" />
												</div>
											</div>
											<div class="form-group">
												<label class="col-sm-3 control-label no-padding-right">
													Sitio Web: </label>
												<div class="col-sm-9">
													<input type="text" name="sitio_web" value=""
