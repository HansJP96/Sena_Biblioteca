		...
		<div class="navbar-container ace-save-state" id="navbar-container">
			...
			<div class="navbar-header pull-left">
				<a href="index.jsp" class="navbar-brand"> <small> <i
						class="fa fa-book"></i> Gestión de libros
				</small>
				</a>
			</div>
		...
		<div id="sidebar"
			...
			<ul class="nav nav-list">
				...
				<li class="active open"><a href="#" class="dropdown-toggle">
						<i class="menu-icon fa fa-book"></i> <span class="menu-text">
							Gestionar libros </span> <b class="arrow fa fa-angle-down"></b>
				</a> <b class="arrow"></b>

					<ul class="submenu">
						<li class="active"><a href="index.jsp"> <i
								class="menu-icon fa fa-caret-right"></i> Lista de libros
						</a> <b class="arrow"></b></li>

						<li class=""><a href="registroLibro.jsp"> <i
								class="menu-icon fa fa-caret-right"></i> Registrar Libro
						</a> <b class="arrow"></b></li>
						<li class=""><a href="registroEditorial.jsp"> <i
								class="menu-icon fa fa-caret-right"></i> Registrar Editorial
						</a> <b class="arrow"></b></li>
						<li class=""><a href="registroCategoria.jsp"> <i
								class="menu-icon fa fa-caret-right"></i> Registrar Categoría
						</a> <b class="arrow"></b></li>
					</ul></li>
		...
		<div class="main-content">
			<div class="main-content-inner">
				<div class="breadcrumbs ace-save-state" id="breadcrumbs">
					<ul class="breadcrumb">
						<li><i class="ace-icon fa fa-home home-icon"></i> <a href="#">Inicio</a>
						</li>
				...
				<div class="page-content">
					...
					<div class="page-header">
						<h1>
							Gestionar los libros <small> <i
								class="ace-icon fa fa-angle-double-right"></i> Lista de libros
							</small>
						</h1>
					</div>
					<!-- /.page-header -->
					...
					<div class="row">
						<div class="col-xs-12">
							...
							<div class="row">
								<div class="col-xs-12">
									<div class="table-header">Registro de Libros</div>
									...
									<div>
										<form action="LibroControl" method="post" class="form-horizontal">
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													<input type="text" name="publicacion" value="" placeholder="Fecha de Publicacion del Libro"/>
												</div>
											</div>
											<div class="form-group">
												<label class="col-sm-3 control-label no-padding-right">
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													<textarea name="descripcion" rows="4" placeholder="Descripcion del Libro"></textarea>
												</div>
											</div>
											<button name="accion" class="btn-success" type="submit" value="registrar">
												<i class="fa fa-save"></i>
												Registrar
											</button>
											<button name="accion" class="btn-warning" type="submit" value="actualizar">
												<i class="fa fa-edit"></i>
												Actualizar
											</button>
											<button name="accion" class="btn-danger" type="submit" value="eliminar">
	...
	<div class="footer">
		<div class="footer-inner">
			<div class="footer-content">
				<span class="bigger-120"> Christian Gámez &copy; 2017-2018 </span>
